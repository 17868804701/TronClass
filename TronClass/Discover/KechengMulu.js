...
export default class KechengMulu extends Component {
    ...
    _renderItem = (info) => {
        ...
        // alert(show)
        return <View
            style={{flexDirection: "row", justifyContent: "center", height: 35, alignItems: "center", display: show}}>
        ...
        const section = [
            {
                ...
                data: [{title: "第一节  复制与粘贴",key:"01"}, {title: "第二节  文档排版",key:"02"}, {title: "第二节  文档排版",key:"03"}, {title: "第二节  文档排版",key:"04"}, {title: "第二节  文档排版",key:"05"}]
            },
            {
                id: 1,
                key: "第二章  Excle的基本操作",
                show: this.state.show,
                data: [{title: "第一节  复制与粘贴",key:"06"}, {title: "第二节  文档排版",key:"07"}, {title: "第二节  文档排版",key:"08"}, {title: "第二节  文档排版",key:"09"}, {title: "第二节  文档排版",key:"10"}]
            },
            {
                id: 1,
                key: "第三章  Excle的基本操作",
                show: this.state.show,
                data: [{title: "第一节  复制与粘贴",key:"15"}, {title: "第二节  文档排版",key:"14"}, {title: "第二节  文档排版",key:"13"}, {title: "第二节  文档排版",key:"12"}, {title: "第二节  文档排版",key:"11"}]
            },
        ];
        this.setState({
            sections: section
    ...
    _sectionComp = (info) => {
        ...
        return <TouchableOpacity onPress={() => {
            ...
            <Image source={require('../../images/down.png')}
                   style={{position: "absolute", right: 20, width: 25, height: 25}}></Image>
        </View>
        </TouchableOpacity>
    };
